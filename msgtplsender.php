 ...
 */
function msgtplsender_civicrm_caseTypes(&$caseTypes) {
  _msgtplsender_civix_civicrm_caseTypes($caseTypes);
}
 ...
 */
function msgtplsender_civicrm_angularModules(&$angularModules) {
  _msgtplsender_civix_civicrm_angularModules($angularModules);
}
 ...
 */
function msgtplsender_civicrm_themes(&$themes) {
  _msgtplsender_civix_civicrm_themes($themes);
}
 ...
 *
function msgtplsender_civicrm_preProcess($formName, &$form) {
 ...
 *
function msgtplsender_civicrm_navigationMenu(&$menu) {
  _msgtplsender_civix_insert_navigation_menu($menu, 'Mailings', array(
  ...
  _msgtplsender_civix_navigationMenu($menu);
} // */
